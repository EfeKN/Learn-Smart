...
import { FaArrowCircleDown, FaCalendarAlt } from "react-icons/fa";
      ...
      <div className="p-10 flex-grow flex flex-col relative bg-transparent">
        {selectedChat ? (
          <div className="flex flex-col h-full">
            ...
            <div className="flex items-center gap-2 mt-4 px-4 rounded-[26px] bg-gray-200 dark:bg-token-main-surface-secondary w-2/3 mx-auto">
          ...
          <div className="text-center mt-20">
            ...
            <div className="mx-3 mt-12 flex flex-col items-center justify-center gap-4">
              <div className="flex flex-wrap items-center justify-center gap-4">
                <button className="relative flex w-40 flex-col gap-2 rounded-2xl border border-token-border-light px-3 pb-4 pt-3 text-start align-top text-[15px] shadow-xxs transition enabled:hover:bg-token-main-surface-secondary disabled:cursor-not-allowed bg-gray-300">
                  <GiSpellBook
                    className="text-2xl"
                ...
                <button className="relative flex w-40 flex-col gap-2 rounded-2xl border border-token-border-light px-3 pb-4 pt-3 text-start align-top text-[15px] shadow-xxs transition enabled:hover:bg-token-main-surface-secondary disabled:cursor-not-allowed bg-gray-300">
                  ...
                  />
                  <div className="line-clamp-3 max-w-full text-balance text-gray-600 dark:text-gray-500 break-word">
                    Weekly Study Plan of {course?.course_name || "the Course"}
                  </div>
                </button>
              </div>
            </div>
